 ...
 * </p>
 * <ul>
 *   <li>{@link circuitoV3.impl.LedImpl#getNumero_pin <em>Numero pin</em>}</li>
 * </ul>
 *
 * @generated
 */
public class LedImpl extends FlowTargetImpl implements Led {
	/**
	...
	protected EClass eStaticClass() {
		return CircuitoV3Package.Literals.LED;
	}
	...
	public void setNumero_pin(int newNumero_pin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CircuitoV3Package.LED__NUMERO_PIN, oldNumero_pin,
					numero_pin));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case CircuitoV3Package.LED__NUMERO_PIN:
